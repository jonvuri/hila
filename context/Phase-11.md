...
Concrete tasks for Phase 11. See [Plan.md](Plan.md) for context and objectives, [Plugins.md](Plugins.md) for the tags plugin design, and [Traits.md](Traits.md) for join kind semantics.
