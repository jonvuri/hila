# Phase 7c -- App structure and cohesive design system (planning placeholder)
...
Follows [Phase 7b](Phase-7b.md). Stages 1-3 (inventory, view hierarchy, composition model) gate stage 4 (token/theming unification and migration). This phase should settle before large new view work or a full `global.css` migration is undertaken.
