...
> **Status: requires current-schema reconciliation.** Phase 3's readiness layer ships, but later
> ownership-spine and view-block schema additions are not all tracked. Rank-era descriptions below
> are historical until proposed Phase 11 audits source-of-truth coverage and rewrites this document.
> Live transport, providers, files, and user-facing sync remain unimplemented.
