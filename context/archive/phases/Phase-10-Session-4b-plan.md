...
Continuation of the session-4 visual fan-out ([index](../visuals/Phase-10-Session-4-themes.html)), moving from
...
| ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| [Phase-10-Session-4-themes.html](../visuals/Phase-10-Session-4-themes.html)                                 | Retired comparison index for the original three-way fan-out         |
| [Phase-10-Session-4-theme-wipeout.html](../visuals/Phase-10-Session-4-theme-wipeout.html)                   | Retired Wipeout catalog; may supply isolated chrome references only |
| [Phase-10-Session-4-theme-null.html](../visuals/Phase-10-Session-4-theme-null.html)                         | Retired Null catalog; intent survives, implementation does not      |
| [Phase-10-Session-4-theme-ultramodern.html](../visuals/Phase-10-Session-4-theme-ultramodern.html)           | Retired Ultramodern direction                                       |
| [Phase-10-Session-4-wipeout-overlaid-cards.html](../visuals/Phase-10-Session-4-wipeout-overlaid-cards.html) | Retired deep dive into six overlaid-card concepts                   |
