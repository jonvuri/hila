...
- **No live sync in this phase.** File storage, Dropbox integration, the sync engine, and sync UI are deferred to [Phase 15](../superseded-roadmap/Phase-15.md). This phase establishes the infrastructure so that all data mutations from Phase 4 onward are tracked and sync-safe.
