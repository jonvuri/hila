...
Concrete tasks for Phase 5. See [Plan.md](../../Plan.md) for context and objectives, [Plugins.md](../../Plugins.md) for the tags plugin design, and [Traits.md](../superseded-topics/Traits-pre-reconciliation.md) for join kind semantics.
